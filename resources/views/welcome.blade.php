...
<body class="min-h-screen bg-slate-950 text-white antialiased">
	...
	<nav class="fixed top-0 w-full z-50 bg-slate-950/80 backdrop-blur-xl border-b border-slate-800/50">
		<div class="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
			<a href="#"
				class="text-xl font-bold bg-gradient-to-r from-blue-600 to-sky-400 bg-clip-text text-transparent">
				DMS
			</a>
			<div class="hidden md:flex items-center gap-8"> <a href="{{ config('app.url') }}/document"
					class="text-sm text-slate-400 hover:text-white transition-colors">Document Management</a>
				<a href="{{ config('app.url') }}/crew"
					class="text-sm text-slate-400 hover:text-white transition-colors">Crew Management</a>
				<a href="{{ config('app.url') }}/admin"
					class="px-4 py-2 bg-white text-slate-900 rounded-lg text-sm font-medium hover:bg-slate-100 transition-colors">
					Login Administrator
				</a>
			</div>
		</div>
	...
	<section class="pt-32 pb-20 px-6">
		<div class="max-w-6xl mx-auto text-center">
			<!-- Badge -->
			<div
				class="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-violet-500/20 rounded-full text-blue-300 text-sm mb-8">
			...
			<h1 class="text-5xl md:text-7xl font-bold tracking-tight mb-6 leading-[1.1]">
				DMS
				<span
					class="block bg-gradient-to-r from-blue-600 via-sky-400 to-sky-300 bg-clip-text text-transparent">
					Haritashipping
				</span>
			</h1>
