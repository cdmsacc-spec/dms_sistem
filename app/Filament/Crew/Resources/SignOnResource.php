...
use App\Filament\Crew\Resources\SignOnResource\Pages;
use App\Filament\Crew\Resources\SignOnResource\RelationManagers;
use App\Filament\Crew\Resources\SignOnResource\RelationManagers\CrewPklRelationManager;
...
class SignOnResource extends Resource
{
    protected static ?string $model = CrewApplicants::class;
    protected static ?string $slug = 'crew-signon';
    ...
    {
        return $table
            ->modifyQueryUsing(fn($query) => $query->where('status_proses', StatusCrew::Standby))
    ...
    {
        return [
            'index' => Pages\ListSignOns::route('/'),
            'create' => Pages\CreateSignOn::route('/create'),
            'edit' => Pages\EditSignOn::route('/{record}/edit'),
        ];
    }
}
