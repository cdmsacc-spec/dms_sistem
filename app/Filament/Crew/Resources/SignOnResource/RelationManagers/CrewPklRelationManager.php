...
namespace App\Filament\Crew\Resources\SignOnResource\RelationManagers;
...
class CrewPklRelationManager extends RelationManager
{
    ...
    // {
    //     $record->crew()->update(['status_proses' => 'Active']);
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([])
            ->actions([
                Tables\Actions\Action::make('generate_document_signon')
                    ->button()
