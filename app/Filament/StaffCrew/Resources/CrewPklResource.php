...
use App\Filament\StaffCrew\Pages\DetailKontrakPkl;
use App\Filament\StaffCrew\Resources\CrewPklResource\Pages;
use App\Filament\StaffCrew\Resources\CrewPklResource\RelationManagers;
...
class CrewPklResource extends Resource
{
                ...
                Forms\Components\Section::make('Crew Info')
                    ...
                    ->headerActions([
                        Forms\Components\Actions\Action::make('Selengkapnya')
                            ->url(fn($record) => CrewOverviewResource::getUrl('view', ['record' => $record->crew->id]))
    ...
    {
        return [
            'index' => Pages\ListCrewPkls::route('/'),
            'create' => Pages\CreateCrewPkl::route('/create'),
            'edit' => Pages\EditCrewPkl::route('/{record}/edit'),
        ];
    }
}
