...
use App\Filament\StaffCrew\Resources\CrewPromosiResource\Pages;
use App\Filament\StaffCrew\Resources\CrewPromosiResource\RelationManagers\CrewPklRelationManager;
...
class CrewPromosiResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListCrewPromosis::route('/'),
            'create' => Pages\CreateCrewPromosi::route('/create'),
            'edit' => Pages\EditCrewPromosi::route('/{record}/edit'),
            'view' => Pages\ViewCrewPromosi::route('/{record}'),
