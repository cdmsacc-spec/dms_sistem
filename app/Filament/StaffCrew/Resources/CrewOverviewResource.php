...
use App\Filament\StaffCrew\CrewOverviewResource\Widget\CrewOverviewStats;
use App\Filament\StaffCrew\Resources\CrewOverviewResource\Pages\ViewCrewOverview;
use App\Filament\StaffCrew\Resources\CrewOverviewResource\RelationManagers\CrewCertificatesRelationManager;
use App\Filament\StaffCrew\Resources\CrewOverviewResource\RelationManagers\CrewExperienceRelationManager;
use App\Filament\StaffCrew\Resources\CrewOverviewResource\RelationManagers\CrewDocumentRelationManager;
use App\Filament\StaffCrew\Resources\CrewOverviewResource\Pages;
...
class CrewOverviewResource extends Resource
{
    protected static ?string $model = CrewApplicants::class;

    protected static ?string $navigationIcon = 'heroicon-o-user-group';
    protected static ?string $navigationLabel = 'Crew Overview';
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('status_identitas')
                    ->searchable(),
                Tables\Columns\SelectColumn::make('status_proses')
                    ->options([
                        'Draft' => 'Draft',
                        'Ready For Interview' => 'Ready For Interview',
                        'Inactive' => 'Inactive',
                    ...
                    ->rules(['required'])
                    ->sortable()
                    ->afterStateUpdated(fn($state, $record) => $record->update(['status_proses' => $state])),
            ...
            ->filters([
                ...
                \Filament\Tables\Filters\SelectFilter::make('jabatan')
                    ...
                    ->native(false)
                    ->options(function () {
                        return Jabatan::whereHas('crewPkl', function ($q) {
                            $q->where('status_kontrak', 'Active');
                        })->pluck('golongan', 'golongan')->toArray();
                    })


                    ->query(function ($query, $data) {
                        // $data['value'] berisi value yang dipilih user
    ...
    {
        return [
            'index' => Pages\ListCrewOverviews::route('/'),
            'create' => Pages\CreateCrewOverview::route('/create'),
            'edit' => Pages\EditCrewOverview::route('/{record}/edit'),
