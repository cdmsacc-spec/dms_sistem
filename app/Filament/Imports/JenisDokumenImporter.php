...
class JenisDokumenImporter extends Importer
{
    ...
    public function resolveRecord(): JenisDokumen
    {
        return JenisDokumen::firstOrNew([
    ...
    {
        $body = 'Your jenis dokumen import has completed and ' . Number::format($import->successful_rows) . ' ' . str('row')->plural($import->successful_rows) . ' imported.';
